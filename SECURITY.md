...
Quorum is pre-1.0. Only the latest release (and `main`) receive security fixes.
...
[https://github.com/shakehasan/quorum/security/advisories/new](https://github.com/shakehasan/quorum/security/advisories/new)
...
- Quorum's default runtime is local-first; the FastAPI service ships with simple local token auth and
